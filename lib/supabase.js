...
// No hardcoded credentials. Enter your Supabase URL and anon key in the app:
// Settings tab → Supabase Connection → enter URL and key → Connect.
// Use "Clear" to remove saved credentials and enter new ones.

// Client is only set when you click Connect in Settings (user's credentials).
